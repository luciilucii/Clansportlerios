...
class GroupHorizontalCell: BaseCell {
    ...
    fileprivate func setupWhiteView() {
        ...
        gameImageView.anchor(top: backgroundWhiteView.topAnchor, left: backgroundWhiteView.leftAnchor, bottom: backgroundWhiteView.bottomAnchor, right: nil, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 125, height: 0)
        
        descriptionLabel.anchor(top: backgroundWhiteView.topAnchor, left: gameImageView.rightAnchor, bottom: backgroundWhiteView.bottomAnchor, right: backgroundWhiteView.rightAnchor, paddingTop: 0, paddingLeft: 4, paddingBottom: 0, paddingRight: 4, width: 0, height: 75)
        
        usernameLabel.anchor(top: nil, left: gameImageView.rightAnchor, bottom: bottomAnchor, right: centerXAnchor, paddingTop: 0, paddingLeft: 4, paddingBottom: 0, paddingRight: -30, width: 0, height: 25)
        
        timestampLabel.anchor(top: nil, left: centerXAnchor, bottom: bottomAnchor, right: backgroundWhiteView.rightAnchor, paddingTop: 0, paddingLeft: 34, paddingBottom: 0, paddingRight: 8, width: 0, height: 25)
